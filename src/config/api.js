...
export const API_ENDPOINTS = {
  ...
  ADMIN: {
    ...
    ORDERS: (params = "") => `${API_BASE_URL}/admin/orders${params}`,
    ORDER_DETAILS: (orderId) => `${API_BASE_URL}/admin/orders/${orderId}`,
  ...
  SELLER: {
    ...
    ORDER_DETAILS: (orderId) => `${API_BASE_URL}/orders/seller/orders/${orderId}`,
